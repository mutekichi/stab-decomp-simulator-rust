...
t q[0];"#;
    ...
    fn test_qasm_parser_errors() {
        ...
        let qasm_str_unsupported_gate = r#"OPENQASM 2.0;
include "qelib1.inc";
qreg q[1];
rx(pi/4) q[0];"#;

        let result = from_qasm_str(qasm_str_unsupported_gate);
        assert!(
            result.is_err(),
        ...
        let qasm_str_bad_syntax = r#"OPENQASM 2.0;
include "qelib1.inc";
qreg q[1]
h q[0]"#;
        assert!(
            from_qasm_str(qasm_str_bad_syntax).is_err(),
